 ...
 */
MapTo('canada-demo/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('canada-demo/components/separator')(SeparatorV1Component);

MapTo('canada-demo/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('canada-demo/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('canada-demo/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('canada-demo/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('canada-demo/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('canada-demo/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('canada-demo/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('canada-demo/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('canada-demo/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('canada-demo/components/accordion')(AccordionV1Component);
MapTo('canada-demo/components/tabs')(TabsV1Component);
...
LazyMapTo('canada-demo/components/teaser')(TeaserV1Component);
...
LazyMapTo('canada-demo/components/carousel')(CarouselV1Component);
...
LazyMapTo('canada-demo/components/text')(LazyTextModule, TextEditConfig);